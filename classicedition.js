...
function corrections() {
  ...
  document.getElementById("enlarge5token").innerHTML +=
    '<img src="img/icon.jpg" height="60" width="65" alt="" style="position: relative; bottom: 20px;" />';
  document.getElementById("enlarge15token").innerHTML +=
    '<img src="img/icon.jpg" height="60" width="65" alt="" style="position: relative; top: -20px;" />';
  ...
  document.getElementById("enlarge12token").innerHTML +=
    '<img src="img/icon.jpg" height="60" width="48" alt="" style="position: relative; top: -20px;" />';
...
communityChestCards[1] = new Card(
  "You have won second prize in a innovation contest. Collect $10.",
  function () {
    addamount(10, "Community Chest");
  }
);
communityChestCards[2] = new Card(
  "You get 50$ for visiting the library instead using Chat GPT.",
  function () {
    addamount(50, "Community Chest");
  }
);
communityChestCards[3] = new Card(
  "You used too much paper in office, pay 50$",
  function () {
    substractamount(50, "Community Chest");
  }
);
communityChestCards[4] = new Card(
  "Your mom makes bugers out of roaches. Collect $20.",
  function () {
    addamount(20, "Community Chest");
  }
);
communityChestCards[5] = new Card(
  "You sell your CO2 certificates. Receive $100.",
  function () {
    addamount(100, "Community Chest");
  }
);
communityChestCards[6] = new Card(
  "You develop a automated driving system, gain $100.",
  function () {
    addamount(100, "Community Chest");
  }
);
communityChestCards[7] = new Card(
  "You tell Elon Musk to invest in Doge Coin get $25 consultancy fee.",
  function () {
    addamount(25, "Community Chest");
  }
);
communityChestCards[8] = new Card(
  "Your investment in Blue Origin failde, you lose $100.",
  function () {
    subtractamount(100, "Community Chest");
  }
);
communityChestCards[9] = new Card(
  "You steal a new batterie technologie, Collect $200.",
  function () {
    addamount(200, "Community Chest");
  }
);
communityChestCards[10] = new Card(
  "Pay your Netflix subscription of $50.",
  function () {
    subtractamount(50, "Community Chest");
  }
);
communityChestCards[11] = new Card(
  "You buy a new smart Fridge. Pay $50.",
  function () {
    subtractamount(50, "Community Chest");
  }
);
...
communityChestCards[14] = new Card(
  "You research facilities areon strike. Pay $40 per lab. $115 per research facility.",
  function () {
...
chanceCards[1] = new Card(
  "Your Facilities need new technoligcal equipment. For each lab pay $25. For each research facility $100.",
  function () {
    streetrepairs(25, 100);
  }
);
chanceCards[2] = new Card("Eco fine $15.", function () {
...
chanceCards[9] = new Card(
  'Take a trip to ********************** If you pass "GO" collect $200.',
  function () {
    advance(5);
  }
);
chanceCards[10] = new Card("ADVANCE to ***********************.", function () {
  advance(39);
});
chanceCards[11] = new Card(
  'ADVANCE to ****************************. If you pass "GO" collect $200.',
  function () {
    advance(24);
  }
);
